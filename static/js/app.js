...
import { downloadAlbum, triggerDirectDownload, downloadQueue } from './modules/downloader.js';
import { player } from './modules/player.js';
import { displayResults, updateDownloadManagerStatus, showTrackListInModal, displayHomepage, appendResultsToWall, updateDownloadQueueModal } from './modules/ui.js';
...
function bindEventListeners() {
    ...
    const closeModal = (modal) => {
        ...
        if (modal === dom.tracklistModal) dom.artistModal.classList.remove('is-covered');
    ...
    dom.artistModalCloseBtn.addEventListener('click', () => closeModal(dom.artistModal));
    ...
    window.addEventListener('click', (e) => {
        ...
        if (e.target == dom.artistModal) closeModal(dom.artistModal);
    ...
    dom.playerAudioElement.addEventListener('timeupdate', () => {
        ...
        if (bar && dom.playerAudioElement.duration) {
            bar.value = (dom.playerAudioElement.currentTime / dom.playerAudioElement.duration) * 100;
        }
    });
}